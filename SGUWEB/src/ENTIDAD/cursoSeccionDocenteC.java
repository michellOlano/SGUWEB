...
public class cursoSeccionDocenteC implements Serializable{
    ...
    public cursoSeccionDocenteC(int institucion, String periodo, String carrera, String malla, String grupo, String curso, String seccion, String personal, int hora_teoria, int hora_practica, int estadoRegistro,carreraC itemCarrera,cursoC itemCurso,seccionC itemSeccion) {
        this.institucion = institucion;
        this.periodo = periodo;
        this.carrera = carrera;
        this.malla = malla;
