...
public class personalC implements Serializable{
    ...
    public personalC(String personal, String persona, boolean codigoPlanilla, String cPersonal, int estadoRegistro,personaC itemPersona) {
        this.personal = personal;
        this.persona = persona;
        this.codigoPlanilla = codigoPlanilla;
        this.cPersonal = cPersonal;
    ...
    public personalC(String personal, String persona, boolean codigoPlanilla, String cPersonal, int estadoRegistro,localC itemSede,personaC itemPersona) {
        this.personal = personal;
        this.persona = persona;
        this.codigoPlanilla = codigoPlanilla;
        this.cPersonal = cPersonal;
	...
	public localC getItemSede() {
		return itemSede;
	}

	public void setItemSede(localC itemSede) {
		this.itemSede = itemSede;
	}
