...
public class registrotmC extends util implements Serializable  {
    ...
    private tipoHoraC itemTipoHora;
    ...
    public registrotmC(int id, int institucion, String periodo, String malla, String grupo, Date fecha_inicio, Date fecha_fin, int dia, Date hora_inicio, Date hora_fin, String personal, String cpersonal, String carrera, String curso, String seccion, String aula,  int turno,int sede,int tipoClase,int tipoHora, String observacion,Date fechaRecuperacion,Date horaInicioRecuperacion,Date horaFinRecuperacion, int estadoRegistro) {
        this.id = id;
    ...
    public double totalHoras(int duracion){   	
    	...
    	return  totalMinutos()  /duracion;
    }
    public double totalHora(){   	
    	
    	return  totalMinutos()  /itemTipoHora.getDuracion();
    }
	...
	public tipoHoraC getItemTipoHora() {
		return itemTipoHora;
	}

	public void setItemTipoHora(tipoHoraC itemTipoHora) {
		this.itemTipoHora = itemTipoHora;
	}
