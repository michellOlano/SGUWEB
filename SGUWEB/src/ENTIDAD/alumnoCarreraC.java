...
public class alumnoCarreraC implements Serializable {
    ...
    public alumnoCarreraC( int institucion,String carrera, String alumno,String malla, String categoria,String descuento, double creditosAcumulados, double promedioPonderado, int ordenPonderado, String periodoIngreso, int estadoRegistro,carreraC itemCarrera) {
		this.institucion=institucion;
		this.carrera=carrera;
		this.alumno=alumno;
		this.malla=malla;
