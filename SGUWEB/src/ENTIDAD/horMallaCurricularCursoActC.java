...
public class horMallaCurricularCursoActC implements Serializable{
    ...
    public horMallaCurricularCursoActC(	 int institucion, String carrera, String malla,String curso, int creditos, int nivelModular,int horasTeoria,  int horasPracticas,int tipoCurso, int estadoRegistro,cursoC itemCurso) {
	    this.institucion=institucion;
	    this.carrera=carrera;
	    this.malla=malla;
	    this.curso=curso;
