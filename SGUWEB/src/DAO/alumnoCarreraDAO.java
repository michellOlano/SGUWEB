...
public class alumnoCarreraDAO extends Conexion implements Serializable {
	...
	private static final long serialVersionUID = 1L;
	 ...
	 public String actualizar(alumnoCarreraC item) {	        
	        Connection c ;
	        CallableStatement cs ;
	        boolean rpta ;
	        String codigo = "";
	...
	public alumnoCarreraC mostrarAlumnoCarrera(int institucion, String alumno) {
        ...
        try {
            ...
            c = ConexionWeb();
            cs = c.prepareCall("SELECT A.* ,B.DESCRIPCION DESCARRERA FROM SIGU.ACA_ALUMNO_CARRERA A,UPA.ACA_CARRERAS B WHERE INSTITUCION=? AND ALUMNO=? AND B.CARRERA=A.CARRERA   ");
            ...
            while (rs.next()) {
            	...
            	item.setFechaControl(rs.getDate("CONTROL_FECHA"));
