...
public class centroEducativoDAO extends Conexion implements Serializable {
	...
	public List<centroEducativoC> mostrarCentroEducativo(int tipo) {
        ...
        try {
            ...
            c = ConexionWeb();
            cs = c.prepareCall("SELECT * FROM DI.SYS_CENTRO_EDUCATIVO WHERE TIPO_CENTRO_EDUCATIVO=?  AND ESTADO_REGISTRO=1 ORDER BY DESCRIPCION");
            cs.setInt(1, tipo);
    ...
    public List<centroEducativoC> filtrarCentroEducativo(String descripcion) {
        ...
        try {
            ...
            c = ConexionWeb();
            cs = c.prepareCall("SELECT TOP 50 * FROM DI.SYS_CENTRO_EDUCATIVO WHERE DESCRIPCION LIKE ? ");
    ...
    public List<centroEducativoC> mostrarCentroEducativo() {
        ...
        try {
            ...
            c = ConexionWeb();
            cs = c.prepareCall("SELECT * FROM DI.SYS_CENTRO_EDUCATIVO ORDER BY TIPO_CENTRO_EDUCATIVO, DESCRIPCION  ");  
            rs = cs.executeQuery();
