...
public class alumnoPeriodoDAO extends Conexion implements Serializable {
	...
	private static final long serialVersionUID = 1L;
	   ...
	   public String insertar(alumnoPeriodoC item) {
	        ...
	        try {
	            c = ConexionWeb();
	            cs = c.prepareCall("{CALL DI.SP_MANTENIMIENTO_ALUMNO_PERIODO(?,?,?,?,?,?,?,?,?,? ,?,?,?,?,?,?,?,?,?,? ,?,?,?,?,?,?,?,?,?,? ,?,?,?,?,?,?,?,?,?,? ,?,?,?,?,?,?)}");
	            cs.setInt("ITEMWEB", 1);
	            ...
	            cs.setString("AUT_DOC_MALLA", item.getAut_doc_malla());
	            cs.setString("AUT_OBS_MALLA", item.getAut_obs_malla());	            
	            cs.setString("AUT_PER_CARRERA", item.getAut_per_carrera());
	            
	            cs.setString("AUT_DOC_CARRERA", item.getAut_doc_carrera());
	            cs.setString("AUT_OBS_CARRERA", item.getAut_obs_carrera());	            
	            cs.setString("AUT_PER_CATEGORIA", item.getAut_per_categoria());
	            cs.setString("AUT_DOC_CATEGORIA", item.getAut_doc_categoria());
	            cs.setString("AUT_OBS_CATEGORIA", item.getAut_obs_categoria()); 
	   ...
	   public String actualizar(alumnoPeriodoC item) {
