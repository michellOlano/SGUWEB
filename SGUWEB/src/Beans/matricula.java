...
public class matricula implements Serializable {
    ...
    private List<cursoC> cursosExtraL;
    ...
    public void load(int institucion, String periodo) {
        ...
        if (!codigo.toString().isEmpty()) {
            ...
            carreraL=new carreraDAO().mostrarListaCarreraAlumno(institucion, codigo);
        }
    ...
    public void autorizacion() {
        ...
        if (varAutoriazacion == 1) {
            ...
            if (new matriculaDAO().InsertaMatricula(institucion, periodo, alumnoCarrera.getMalla(), new carreraDAO().mostrarCarreraAlumno(institucion, codigo).getCarrera(), codigo, 0, 0, listacursos)) {
    ...
    public void insertarCursos() {
        ...
        if (new matriculaDAO().InsertaMatricula(institucion, periodo, alumnoCarrera.getMalla(), new carreraDAO().mostrarCarreraAlumno(institucion, codigo).getCarrera(), codigo, totalMatriculados, totalCreditos, listacursos)) {
            listaMatricula = new matriculaDAO().mostrarMatriculaAlumno(institucion, periodo, codigo);
            alumnoUltimoPeriodo = new matriculaDAO().ultimaMatricula(institucion, codigo);
    ...
    public List<cursoC> getCursosExtraL() {
        return cursosExtraL;
    }
    public void setCursosExtraL(List<cursoC> cursosExtraL) {
