...
public class admin_notas implements Serializable {
    ...
    private List<carreraC> listaCarreraDocente;
    private List<cursoC> listaCursoDocente;
...
cursoPeriodoDAO cursoPeriodoD;
     ...
     public void seleccionBusqueda(){
    	 ...
    	 listaCarreraDocente = new carreraDAO().mostrarCarrerasDocentePeriodo(institucion, periodo, seleccionDocente);
...
//       //   --------------------------------------------
    ...
    public void refrescarInstitucionPeriodo(int institucion, String periodo,String usuario,int programa,String modulo) {
    ...
    public List<carreraC> listarCarrerarDocente() {
    ...
    public List<cursoC> getListaCursoDocente() {
        return listaCursoDocente;
    }

    public void setListaCursoDocente(List<cursoC> listaCursoDocente) {
        this.listaCursoDocente = listaCursoDocente;
    }
    public List<carreraC> getListaCarreraDocente() {

        return listaCarreraDocente;
    }
    public void setListaCarreraDocente(List<carreraC> listaCarreraDocente) {
