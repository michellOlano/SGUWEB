...
public class horarioExamen {
   ...
   public void mensaje(){
    ...
    public void mostrarHorarioExamen(){
       ...
       seccionPeriodo=new seccionPeriodoDAO().mostrarSeccionPeriodo(1, "20162", carreraS, seccionS);
       
       
       
      
       semanaExamenes=new semanaExamenDAO().mostrarSemanaExamenes(1, "20162", seccionPeriodo.getVencimiento(), tipoExamenS);  
         detalleDia itemDia;
         ...
         if( semanaExamenes!=null){
           for(int dia=0;dia<=7;dia++){
             ...
             for (detalleHorario itemHorario : new horarioSemanalDAO().mostrarHorarioExamen(1, "20162",carreraS,seccionS,tipoExamenS,dia,util.dateAdd(semanaExamenes.getFechaInicio(), 5, dia))) {
